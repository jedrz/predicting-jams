...
Wizualizacja danych zawarta jest w~pliku \verb+visualize.py+. Możliwe jest wybranie kilku: wyświetlenie mapy, wyświetlenie krawędzi na~mapie, czy też samych punktów, wybranie i~wyświetlenie korku.
...
\begin{enumerate}
\item \verb+predict+ -- dla danego korku, przewiduje kolejno zakorkowane segmenty dróg w~40 minutach,
